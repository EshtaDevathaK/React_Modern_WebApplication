  ...
  return (
    <div className="bg-white rounded-xl shadow-soft p-4 md:p-6 h-full">
      <div className="flex justify-between items-center mb-4">
        <h2 className="font-heading text-xl font-semibold text-navy">Outfit of the Day</h2>
        <Badge variant="outline" className={`${seasonalOutfit.colorScheme} px-3 py-1 flex items-center gap-1`}>
          {seasonalOutfit.seasonIcon}
          <span>{seasonalOutfit.seasonName}</span>
        </Badge>
      </div>
      ...
      <div className="flex flex-col h-full">
        <div className="mb-4">
          <div className="text-lg font-medium">
            {weather.current.condition.text} • {Math.round(weather.current.temp_c)}°C
          </div>
          <p className="text-gray-600 text-sm mt-1">
            {weather.current.temp_c < 10 
              ? "Bundle up well today" 
        ...
        <div className={`rounded-lg p-4 flex-grow ${seasonalOutfit.colorScheme}`}>
          <div className="flex flex-col h-full">
            <div className="space-y-3 mb-4">
              <div className="flex items-center border-b border-gray-200 pb-2">
                <span className="text-xl mr-3">👕</span>
                <span className="font-medium">{seasonalOutfit.top}</span>
              </div>
              
              <div className="flex items-center border-b border-gray-200 pb-2">
                <span className="text-xl mr-3">👖</span>
                <span className="font-medium">{seasonalOutfit.bottom}</span>
              </div>
              
              <div className="flex items-center border-b border-gray-200 pb-2">
                <span className="text-xl mr-3">🧥</span>
                <span className="font-medium">{seasonalOutfit.outer}</span>
              </div>
              
              <div className="flex items-center border-b border-gray-200 pb-2">
                <span className="text-xl mr-3">👟</span>
                <span className="font-medium">{seasonalOutfit.footwear}</span>
              </div>
            </div>
